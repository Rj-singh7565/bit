...
const DEFAULT_SESSION_SECRET = "e9f4a7c8b2d1e0f3a5b7c9d1e3f5a7b9c1d3e5f7a9b1c3d5e7f9a1b3c5d7e9f1";
...
// Helper to get effective secret
      ...
      data: {
        ...
        studentProfile: {
          create: {
            ...
            feeBalance: 24500.00,
            feeStatus: "PENDING",
            hostelRoom: "OGRA Boys Hostel-305",
